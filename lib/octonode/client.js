...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.handleResponse = function(callback) {
      var _this = this;
      return function(err, res, body) {
        var iter, mi;
        mi = 0;
        iter = function(err, res, body) {
          var next, _ref;
          if (mi < _this.middlewares.length) {
            next = _this.middlewares[mi++];
            try {
              return next(err, res, body, iter);
            } catch (_error) {
              err = _error;
              return callback(err);
            }
